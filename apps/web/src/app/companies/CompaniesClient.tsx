// apps/web/src/app/companies/CompaniesClient.tsx
"use client";
...
export function CompaniesClient({
  ...
  const [companies, setCompanies] = React.useState<Company[]>(initialData.items);
  ...
  return (
    <div className="space-y-4">
      ...
      <FloatingAddButton href="/companies/new" label="取引先を追加" />
    </div>
  );
}